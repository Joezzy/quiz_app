...
import 'package:quizzez/firebase/firebase_configs.dart';
import 'package:quizzez/models/models.dart';
import 'package:quizzez/screens/screens.dart';
import 'package:quizzez/utils/logger.dart';
import 'package:quizzez/widgets/dialogs/dialogs.dart';
...
class QuizController extends GetxController {
  ...
  void loadData(QuizPaperModel quizPaper) async {
    ...
    // try {
      ...
      print("Answers:${questions.first.answers}");
      print(questions.first.selectedAnswer);

      quizPaper.questions = questions;
      for (Question _question in quizPaper.questions!) {
        print("PAPER_ID:${quizPaper.id}");
        print("QUSTION_ID:${_question.id}");
